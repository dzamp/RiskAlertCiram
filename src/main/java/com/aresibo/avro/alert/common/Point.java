...
public class Point extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -8805568431823210298L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Point\",\"namespace\":\"com.aresibo.avro.alert.common\",\"fields\":[{\"name\":\"latitude\",\"type\":\"double\",\"default\":0.0},{\"name\":\"longitude\",\"type\":\"double\",\"default\":0.0}]}");
   ...
   */
  public static com.aresibo.avro.alert.common.Point.Builder newBuilder() {
    return new com.aresibo.avro.alert.common.Point.Builder();
  }
   ...
   * @return A new Point RecordBuilder
   */
  public static com.aresibo.avro.alert.common.Point.Builder newBuilder(com.aresibo.avro.alert.common.Point.Builder other) {
    if (other == null) {
      return new com.aresibo.avro.alert.common.Point.Builder();
    } else {
      return new com.aresibo.avro.alert.common.Point.Builder(other);
    }
  }
   ...
   * @return A new Point RecordBuilder
   */
  public static com.aresibo.avro.alert.common.Point.Builder newBuilder(com.aresibo.avro.alert.common.Point other) {
    if (other == null) {
      return new com.aresibo.avro.alert.common.Point.Builder();
    } else {
      return new com.aresibo.avro.alert.common.Point.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Point>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.aresibo.avro.alert.common.Point.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.aresibo.avro.alert.common.Point other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.latitude)) {
        this.latitude = data().deepCopy(fields()[0].schema(), other.latitude);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.aresibo.avro.alert.common.Point.Builder setLatitude(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.aresibo.avro.alert.common.Point.Builder clearLatitude() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.aresibo.avro.alert.common.Point.Builder setLongitude(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.aresibo.avro.alert.common.Point.Builder clearLongitude() {
